...
class ButtonsDelegate(
    ...
    override fun createViewHolder(parent: ViewGroup) = ViewHolder(parent.inflate(R.layout.item_buttons), onClick)
    ...
    class ViewHolder(
        ...
        override suspend fun bind(item: ButtonsWidget) {
            ...
            item.buttons.map { button ->
                container.inflate(R.layout.item_button, true).apply {
